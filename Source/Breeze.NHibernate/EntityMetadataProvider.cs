...
namespace Breeze.NHibernate
{
    ...
    public class EntityMetadataProvider : IEntityMetadataProvider
    {
        ...
        /// <summary>
        /// Constructs an instance of <see cref="EntityMetadataProvider"/>.
        /// </summary>
        ...
        private EntityMetadata CreateMetadata(Type entityType)
        {
            ...
            return new EntityMetadata(
                ...
                pkPropertyTypes.Select(_dataTypeProvider.GetDataType).ToList(),
            ...
            for (var i = 0; i < propertyNames.Length; i++)
            {
                ...
                for (var j = 0; j < columnNames.Length; j++)
                {
                    ...
                    yield return new SyntheticForeignKeyProperty
                    {
                        ...
                        IdentifierDataType = _dataTypeProvider.GetDataType(relatedPkPropertyType),
        ...
        private AutoGeneratedKeyType GetAutoGeneratedKeyType(AbstractEntityPersister persister)
        {
            ...
            if (!_dataTypeProvider.HasClientGenerator(persister.IdentifierType))
            {
